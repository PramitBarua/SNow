...
const About = () => {
  ...
  return (
    <div className={styles.aboutDivWrapper}>
      <p>
        This website is about finding information on popular movies, tv-series,
        and persons. You can also search for what movie/series you want to see
        next based on your criteria. Please click{" "}
        <a href="/advSearch">
          <em>Explore</em>
        </a>{" "}
        for the detailed search.
      </p>
      <p>
        In this project, I have used JavaScript library <span>React</span> for
        front-end programming, <span>SASS</span> for styling, and the public API{" "}
